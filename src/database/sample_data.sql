...
('course01-0000-1111-2222-333333333333', 'Lập trình Web Full-stack với React & Node.js', 'Khóa học toàn diện về phát triển ứng dụng web từ frontend đến backend sử dụng React.js và Node.js', NULL, '2025-09-01', '2025-09-30', '2025-08-15', '2025-08-30', '2025-10-05', 1, 4, 'web2024', 'teach001-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course02-0000-1111-2222-333333333333', 'Xây dựng API RESTful và Microservices', 'Học cách thiết kế và phát triển API RESTful, kiến trúc microservices và tích hợp các dịch vụ', NULL, '2025-09-01', '2025-09-30', '2025-08-15', '2025-08-30', '2025-10-05', 1, 3, 'api2024', 'teach001-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course03-0000-1111-2222-333333333333', 'Trí tuệ nhân tạo cơ bản với Python', 'Khóa học nhập môn về AI, machine learning và deep learning sử dụng Python và các thư viện phổ biến', NULL, '2025-09-02', '2025-09-30', '2025-08-16', '2025-08-31', '2025-10-06', 1, 3, 'ai2024', 'teach002-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course04-0000-1111-2222-333333333333', 'Xử lý ngôn ngữ tự nhiên (NLP)', 'Nghiên cứu và ứng dụng các kỹ thuật NLP trong việc xử lý và phân tích văn bản', NULL, '2025-09-02', '2025-09-30', '2025-08-16', '2025-08-31', '2025-10-06', 1, 2, 'nlp2024', 'teach002-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course05-0000-1111-2222-333333333333', 'Machine Learning thực hành', 'Áp dụng các thuật toán machine learning vào các bài toán thực tế với dataset lớn', NULL, '2025-09-03', '2025-09-30', '2025-08-17', '2025-09-01', '2025-10-07', 1, 4, 'ml2024', 'teach003-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course06-0000-1111-2222-333333333333', 'Deep Learning và Neural Networks', 'Nghiên cứu sâu về mạng neural, CNN, RNN và các kiến trúc deep learning hiện đại', NULL, '2025-09-03', '2025-09-30', '2025-08-17', '2025-09-01', '2025-10-07', 1, 3, 'dl2024', 'teach003-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course07-0000-1111-2222-333333333333', 'Phân tích dữ liệu với Python và R', 'Sử dụng Python và R để thu thập, xử lý và phân tích dữ liệu lớn từ nhiều nguồn khác nhau', NULL, '2025-09-04', '2025-09-30', '2025-08-18', '2025-09-02', '2025-10-08', 1, 3, 'data2024', 'teach004-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course08-0000-1111-2222-333333333333', 'Big Data và Data Mining', 'Nghiên cứu các kỹ thuật khai phá dữ liệu và xử lý big data với Hadoop, Spark', NULL, '2025-09-04', '2025-09-30', '2025-08-18', '2025-09-02', '2025-10-08', 1, 2, 'bigdata2024', 'teach004-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course09-0000-1111-2222-333333333333', 'Cloud Computing với AWS', 'Triển khai và quản lý ứng dụng trên Amazon Web Services, học các dịch vụ cloud cơ bản', NULL, '2025-09-05', '2025-09-30', '2025-08-19', '2025-09-03', '2025-10-09', 1, 4, 'aws2024', 'teach005-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course10-0000-1111-2222-333333333333', 'DevOps và CI/CD Pipeline', 'Tự động hóa quy trình phát triển phần mềm với Docker, Kubernetes và các công cụ DevOps', NULL, '2025-09-05', '2025-09-30', '2025-08-19', '2025-09-03', '2025-10-09', 1, 3, 'devops2024', 'teach005-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course11-0000-1111-2222-333333333333', 'Internet of Things (IoT) cơ bản', 'Xây dựng hệ thống IoT với Arduino, Raspberry Pi và các cảm biến thông minh', NULL, '2025-09-08', '2025-09-30', '2025-08-22', '2025-09-06', '2025-10-12', 1, 3, 'iot2024', 'teach006-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course12-0000-1111-2222-333333333333', 'Smart Home và Industrial IoT', 'Nghiên cứu ứng dụng IoT trong nhà thông minh và công nghiệp 4.0', NULL, '2025-09-08', '2025-09-30', '2025-08-22', '2025-09-06', '2025-10-12', 1, 2, 'smartiot2024', 'teach006-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course13-0000-1111-2222-333333333333', 'Blockchain và Cryptocurrency', 'Hiểu về công nghệ blockchain, smart contracts và phát triển ứng dụng DeFi', NULL, '2025-09-10', '2025-09-30', '2025-08-24', '2025-09-08', '2025-10-14', 1, 3, 'blockchain2024', 'teach007-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course14-0000-1111-2222-333333333333', 'Web3 và Decentralized Applications', 'Nghiên cứu và phát triển ứng dụng phi tập trung (DApps) trên nền tảng Ethereum', NULL, '2025-09-10', '2025-09-30', '2025-08-24', '2025-09-08', '2025-10-14', 1, 2, 'web3-2024', 'teach007-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course15-0000-1111-2222-333333333333', 'An ninh mạng và Ethical Hacking', 'Học các kỹ thuật bảo mật, kiểm tra thâm nhập và phòng chống tấn công mạng', NULL, '2025-09-12', '2025-09-30', '2025-08-26', '2025-09-10', '2025-10-16', 1, 3, 'security2024', 'teach008-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course16-0000-1111-2222-333333333333', 'Cryptography và Digital Forensics', 'Nghiên cứu mã hóa, chữ ký số và điều tra tội phạm mạng', NULL, '2025-09-12', '2025-09-30', '2025-08-26', '2025-09-10', '2025-10-16', 1, 2, 'crypto2024', 'teach008-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course17-0000-1111-2222-333333333333', 'Robotics và Automation', 'Thiết kế và lập trình robot tự động, học các thuật toán điều khiển và AI robotics', NULL, '2025-09-15', '2025-09-30', '2025-08-29', '2025-09-13', '2025-10-19', 1, 3, 'robot2024', 'teach009-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course18-0000-1111-2222-333333333333', 'Computer Vision cho Robotics', 'Nghiên cứu thị giác máy tính và ứng dụng trong robot thông minh', NULL, '2025-09-15', '2025-09-30', '2025-08-29', '2025-09-13', '2025-10-19', 1, 2, 'vision2024', 'teach009-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL),
('course19-0000-1111-2222-333333333333', 'Data Mining và Business Intelligence', 'Khai phá dữ liệu để hỗ trợ ra quyết định kinh doanh, xây dựng dashboard và báo cáo', NULL, '2025-09-18', '2025-09-30', '2025-09-01', '2025-09-16', '2025-10-22', 1, 4, 'mining2024', 'teach010-0000-1111-2222-333333333333', 'major', NOW(), NOW(), NULL),
('course20-0000-1111-2222-333333333333', 'Predictive Analytics và Forecasting', 'Nghiên cứu các mô hình dự đoán và phân tích xu hướng từ dữ liệu lịch sử', NULL, '2025-09-18', '2025-09-30', '2025-09-01', '2025-09-16', '2025-10-22', 1, 3, 'predict2024', 'teach010-0000-1111-2222-333333333333', 'foundation', NOW(), NOW(), NULL);
